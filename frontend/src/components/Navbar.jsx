...
// const ClipboardContent = ({ setIsFilterOpen, setIsFieldsOpen }) => (
//     <div className="p-8">
...
// // BookContent Component remains the same
// const BookContent = () => (
...
// // FieldsModal Component
// const FieldsModal = ({ isOpen, onClose, selectedFields, onFieldSelection }) => {
//     if (!isOpen) return null;
...
//                 </div>
//                 <div className="space-y-4">
//                     {['Project Name', 'Status', 'Owner', 'Date Modified', 'Date Deployed'].map((field) => (
//                         <div key={field} className="flex items-center">
//                             <input
//                                 type="checkbox"
//                                 checked={selectedFields.includes(field)}
//                                 onChange={() => onFieldSelection(field)}
...
//                     <button onClick={onClose} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Apply</button>
//                 </div>
//             </div>
//         </div>
//     );
